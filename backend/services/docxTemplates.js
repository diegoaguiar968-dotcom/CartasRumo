...
const TEMPLATES = [
  { id: 'objetiva',    disponivel: true,  nome: 'Resposta Objetiva',             descricao: 'Ideal para respostas curtas com 1 a 2 pontos. Tom direto, sem subdivisões.',                                         uso: '1–2 pontos · resposta rápida',            docxStyle: { fonte: 'Calibri', tamanho: 24, espacamentoDepois: 160, espacamentoLinha: 240 }, claudeHint: 'Escreva de forma direta e objetiva. Máximo 2 parágrafos por ponto. Sem seções ou subdivisões. Linguagem formal mas concisa.', arquivo: '3-modelo-anexos.docx' },
  ...
  { id: 'juridica',    disponivel: true,  nome: 'Resposta Jurídico-Regulatória',  descricao: 'Para respostas com fundamentação legal, citação de normas, resoluções ou cláusulas contratuais.',                       uso: 'normas · contratos · fundamentação legal',docxStyle: { fonte: 'Calibri', tamanho: 24, espacamentoDepois: 240, espacamentoLinha: 360 }, claudeHint: 'Use linguagem jurídica formal. Estruture com numeração romana (I., II., III.). Cite normas, resoluções ANTT e cláusulas contratuais.', arquivo: '3-modelo-anexos.docx' },
